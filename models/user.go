...
type User struct {
	...
	LastLogin         time.Time `orm:"column(last_login_time);null" json:"last_login_time"`
	LastLoc           string    `orm:"column(last_login_loc);null;default(从未登陆)" json:"last_login_loc"`
